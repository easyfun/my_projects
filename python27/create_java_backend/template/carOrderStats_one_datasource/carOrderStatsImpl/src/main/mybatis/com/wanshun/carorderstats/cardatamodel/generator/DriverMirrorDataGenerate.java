package {{project_package_name}}.cardatamodel.generator;
...
public class {{project_data_generate}} {
	...
	public void generator(String xmlName) throws Exception{
		...
		Configuration config = cp.parseConfiguration({{project_data_generate}}.class.getResourceAsStream(xmlName));
	...
	public static void main(String[] args) {
		try {
			{{project_data_generate}} generatorSqlmap = new {{project_data_generate}}();
			generatorSqlmap.generator("base.xml");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
